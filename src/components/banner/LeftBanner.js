    ...
    <div className="w-full lgl:w-1/2 flex flex-col gap-20">
      <div className="flex flex-col gap-5">
        ...
        <p className="text-base font-bodyFont leading-6 tracking-wide mt-6 sm:mt-8 lg:mt-8">
          As a full-stack developer with expertise in Shopify and WordPress, I
          craft custom, high-performance websites tailored to your business
          needs. I specialize in building scalable, user-friendly e-commerce
          solutions that drive conversions and deliver seamless experiences.
          With a focus on clean code and results-driven design, I help brands
      ...
      <div className="flex flex-col xl:flex-row gap-6 lgl:gap-0 justify-between">
        <div>
          ...
          <div className="flex gap-4">
            ...
            <a
              href="https://www.linkedin.com/in/rizwan-khan-2964b11a1/"
              target="blank"
            >
              <span className="bannerIcon">
                <FaLinkedinIn />
